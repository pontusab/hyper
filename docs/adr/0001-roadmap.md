...
component-registry distribution model: an npm-published CLI that copies
component source into the user's repo.
...
4. **M3** — OpenAPI, reliability plugins, dev MCP, compiled build
   pipeline, registry-driven CLI + benchmarks, security audit.
